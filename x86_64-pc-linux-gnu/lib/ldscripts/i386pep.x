...
SEARCH_DIR("/home/mcd/android/build-tools-llvm/install/x86_64-pep/lib"); SEARCH_DIR("/home/mcd/android/build-tools-llvm/install/lib"); SEARCH_DIR("/usr/local/lib"); SEARCH_DIR("/lib"); SEARCH_DIR("/usr/lib");
SECTIONS
{
